...
The repository currently contains 276 Rust tests and a differential corpus of
292 output cases plus 121 exception cases. The documented local matrix covers
