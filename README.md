...
The repository currently contains 267 Rust tests and a differential corpus of
285 output cases plus 109 exception cases. The documented local matrix covers
