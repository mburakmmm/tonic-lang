...
The repository currently contains 274 Rust tests and a differential corpus of
290 output cases plus 116 exception cases. The documented local matrix covers
