...
The repository currently contains 268 Rust tests and a differential corpus of
286 output cases plus 109 exception cases. The documented local matrix covers
