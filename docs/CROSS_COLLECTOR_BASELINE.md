...
| Bridge-local `Py_REFCNT` shim + GC-visible exact proxy scanner | 22,585 ms | 22,078–23,149 ms | 442.777 | 2,259 µs |

GC-visible exact proxy yolu ve doğrudan refcount shim'i sıcak tarama süresini ilk
doğru uygulamaya göre yaklaşık %52,9 azalttı. Son yol trace olmayan baseline'a
göre collection başına yaklaşık 1,57 µs ek maliyet getirir. Maliyet yalnız canlı
